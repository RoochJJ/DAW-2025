export function Highlight() {
  return (
    <section className="relative flex bg-[url('../img/etT14XfDEqhQZdD47ywpyihXPyW.jpg')] bg-left bg-cover bg-no-repeat">
      <div className="absolute top-0 left-0 w-full h-full z-1 bg-[linear-gradient(to_right,rgba(17,17,17,1)_calc((50vw-70px)-340px),
      rgba(17,17,17,0.7)_50%,rgba(17,17,17,0.7)_100%)]">
